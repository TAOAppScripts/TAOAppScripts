...
function exportaTodos(designers) 
{
  ...
  var h_extra=["@type_background_img","@comments_img10","@comments_img11","@comments_img12","@comments_img13"]
  //Definimos los nombres de las columnas a crear que no existen en la hoja.
  var h_extra_keys=["Reference","comments_img10","comments_img11","comments_img12","comments_img13"]
